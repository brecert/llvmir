...
const ret = (value) => value instanceof Void
    ? new Ret(value)
    : new Ret(value.type, value);
const nop = new Void;
...
export { index$2 as Instructions, Module, Serializer, index$1 as Types, index as Values, utils };
